package uk.ac.tees.mad.blisstimer.presentation
...
import uk.ac.tees.mad.blisstimer.domain.model.MeditationSession
import uk.ac.tees.mad.blisstimer.domain.model.User
...
class AppViewModel @Inject constructor(
    ...
    fun signUp(context: Context,email : String, password : String, number: String){
        ...
        authentication.createUserWithEmailAndPassword(email, password).addOnSuccessListener {
            firestore.collection("user").document(it.user!!.uid).set(uk.ac.tees.mad.blisstimer.domain.model.User(
                uid = it.user!!.uid,
                email = email,
                number = number,
                password = password
